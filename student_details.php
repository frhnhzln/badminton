...
if(isset($_GET["student_id"])){
	...
	$sql = "SELECT * FROM student WHERE student_id = '$g_code'";
...
<div class="topnav">
  ...
  <a href="staff_students.php">Back</a>
...
<table id="example" class="table table-striped table-bordered">
		...
		//$num_rows = mysqli_num_rows($result);
				...
				echo "<td>" . "<image src='image/".$student_info['image']."'>". "</td>";
				//echo "<td><a class='btn btn-success' href='student_details.php?student_id=" . $row["student_id"] . "' >view details</a>";
				echo "<td><a  class='btn btn-danger' href='student_details.php?delete&student_id=" . $student_info["student_id"] . "' onclick='return confirm('are you sure?');'>delete</a></td>";
				echo "</tr>";
