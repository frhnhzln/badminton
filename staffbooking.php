...
<html>
<head><title>Booking Received</title>
...
<div class="container">
			...
			<br />
			<a href="home_o.php">
 <center><img src="image/bdmntn logo only.png" alt="CoolAdmin" style="width:200px; height:auto; margin-top:50px; margin-right:50px;"></center>
                            </a>
<br><br> -->
<br><br><br><br>
...
<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search booking id.." title="Type in a name">

<table id="myTable">
  <tr class="header">
    <th style="width:30%;">Booking ID</th>
    <th style="width:40%;">Booking Fee</th>
  ...
  <?php
    ...
    if($num_rows > 0){
      ...
      //  echo "<td>" . $row["car_id"] . "</td>";
       ...
       // echo "<td>" . $row["booking_duration"] . " Hours </td>";
        echo "<td>RM " . $row["booking_fee"] . "</td>";
        echo "<td>" . $row["booking_payment"] . "</td>";
        echo "<td><a class='btn btn-warning' href='booking_dstaff.php?booking_id=" . $row["booking_id"] . "' >Details</a></td>";
        echo "<td>" .$action = "";
                if($row["booking_payment"] == 'paid' ){
                    $action = "disabled";
                }

                if($row["booking_payment"] != 'paid'){
        echo "<a class='btn btn-success' href='walkinstaff.php?booking_id=" . $row["booking_id"] . "' >Pay</a></td>";
