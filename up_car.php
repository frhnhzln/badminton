                        ...
                        <div class="login-logo">
                            ...
                            <div class="form-group"  required="required">
                                ...
                                <div class="form-group">
                                    <label>Seat</label>
                                    <input class="au-input au-input--full" id="seat" type="text" class="form-control" name="seat" value="<?php echo $car_info['seat']; ?>" />
                                </div>
								<div class="form-group">
                                    <label>Colour</label>
                                    <input class="au-input au-input--full" id="colour" type="text" class="form-control" name="colour" value="<?php echo $car_info['colour']; ?>" />
                                </div>
                                ...
                                <div class="form-group">
                                    <label>Year</label>
                                    <input class="au-input au-input--full" id="year" type="text" class="form-control" name="year" value="<?php echo $car_info['year']; ?>" />
                                </div>
