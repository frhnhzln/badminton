  ...
  <?php
		...
		if($num_rows > 0){
			...
			while($row = mysqli_fetch_assoc($result)){
				...
				echo "<td><a class='btn btn-success' href='verify.php?id=" . $row["id"] . "' >verify</a>";
				echo "<a  class='btn btn-danger' href='app.php?delete&id=" . $row["id"] . "' onclick='return confirm('are you sure?');'>delete</a></td>";
				echo "</tr>";
			}
			}
        }
