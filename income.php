...
if ($result1->num_rows > 0) {
    ...
    while($row = $result1->fetch_assoc()) {
        echo "Total Sales : RM " . (round($row["value_sum"],2));
    }
  }
?></h2>
<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search booking id.." title="Type in a name" style="width:900px; margin-left:20%">
