...
if(isset($_POST["submit"])){
  ...
  if(!$result){
    ...
    echo "<script>window.open('staffbooking.php','_self')</script>";
  }
}
...
function myFunction() {
  ...
  <p align="center"><a  class='btn btn-danger' href='staffbooking.php' onclick="return confirm('Are you sure to ')">back</a></p>
</form>
