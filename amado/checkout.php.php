...
<div class="txt-heading">Checkout <a id="btnEmpty" href="index.php?action=empty">Empty Cart</a></div>
<?php
if(isset($_SESSION["cart_item"])){
    $item_total = 0;
...
$_SESSION['amount'] = $item_total;
 ?>   
    ...
    <a class='btn btn-danger' href='cimbclicks/login.php'>Cancel</a></td>
    <a class= 'btn btn-success' href='cimbclicks/login.php'>Pay</a></td>
