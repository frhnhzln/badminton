...
<div id="product-grid">
	<div class="txt-heading">Products - <?php echo $_GET["id"];?></div>
	<?php
        $sellerid = $_GET["id"];
	$product_array = $db_handle->runQuery("SELECT * FROM tblproduct WHERE sellerid = '$sellerid' ORDER BY id ASC");
	...
	?>
		<div class="product-item">
			...
			<div><?php echo $product_array[$key]["sellerid"]; ?></div>
