...
if (isset($_SESSION["cart_item"])) {
    ...
    ?>
                            ...
                            ?>   
                        <INPUT type="hidden" name="customerid" value="12"/>
                        <INPUT type="hidden" name="cust_email" value="user@mail.com"/>
...
<?php
$product_array = $db_handle->runQuery("SELECT a.name, a.code, a.price, a.image, a.sellerid, b.firstname, b.surname FROM tblproduct a LEFT JOIN seller b ON a.sellerid=b.id ORDER BY a.id ASC");
        ...
        ?>
                    <div class="product-item">
                        <form method="post" action="index.php?action=add&code=<?php echo $product_array[$key]["code"]; ?>">
                            ...
                            <div><a href="sellercatalogue.php?id=<?php echo $product_array[$key]["sellerid"]; ?>" ><?php echo $product_array[$key]["sellerid"] . "-" .
            $product_array[$key]["firstname"] . " " . $product_array[$key]["surname"];
            ?></a></div>
