...
<table id="myTable">
  ...
  <?php
        ...
        echo "<td>" . $row["info"] . "</td>";
				...
				//echo "<td><a class='btn btn-success' href='up_car.php?car_id=" . $row["id"] . "' >update</a>";
				//echo "<a  class='btn btn-danger' href='cars.php?delete&owner_id=" . $row["id"] . "' onclick='return confirm('are you sure?');'>delete</a></td>";
        echo "</tr>";
