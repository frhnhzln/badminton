...
if(isset($_GET["delete"])){
	...
	$sql = "DELETE FROM staff WHERE id = '$student_id'";
...
<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search staff.." title="Type in a name">
...
<table id="myTable">
  ...
  $num_rows = mysqli_num_rows($result);
        ...
        while($row = mysqli_fetch_assoc($result)){
          ...
          echo "<td>
          <a  class='btn btn-danger' href='staffdetails.php?delete&id=" . $row["id"] . "' onclick='return confirm('are you sure?');'>delete</a></td>";
          echo "</tr>";
			}
			}
    }
