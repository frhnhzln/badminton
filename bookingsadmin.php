...
<table id="myTable">
  ...
  <?php
       ...
       // echo "<td>" . $row["booking_duration"] . " Hours </td>";
        ...
        echo "<td><a class='btn btn-warning' href='booking_details.php?booking_id=" . $row["booking_id"] . "' >Details</a></td>";
        echo "<td>" .$action = "";
                ...
                if($row["booking_payment"] != 'paid'){
				echo "<a class='btn btn-success' href='walkinpay.php?booking_id=" . $row["booking_id"] . "' >Pay</a></td>";
