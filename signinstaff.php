...
if(isset($_POST["submit"])){
	...
	if($result_num_row == 1){
		...
		if($password_valid2 == TRUE){
            ...
            {echo "<script>window.open('unver.php','_self')</script>";}

            if ($row['status']=='verified')
            {
				//echo $status;
				echo "<script>window.open('home_o.php','_self')</script>";
			}
            ...
            <div class="images/icon/platinum.jpg">
                <div class="login-wrap">
                    <div class="login-content">
                        <center><a style="font-size: 30px;">Staff Login</a></center>
                        ...
                        <div class="login-form">
                            ...
                            <div class="register-link">
                                <p>
                                    ...
                                    <a href="register_o.php">Sign Up Here</a>
                                </p>
                            </div>
                        </div>
                    </div>
